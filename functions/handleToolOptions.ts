...
import { interfaceDescriptionSearchGoogleWeb } from '../api/search-googleOptions';
...
export const handleToolOptions = (response: VercelResponse) => {
	return response
		.status(200)
		.json({ interfaceDescriptionWeather, interfaceDescriptionIP, interfaceDescriptionLocationResolver, interfaceDescriptionSearchGoogleWeb });
};
