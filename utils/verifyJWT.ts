...
export type JWTVerificationResult = { valid: true; payload: any } | { valid: false; error: 'expired' | 'malformed' | 'invalid' };
 ...
 */
export function verifyRequestToken(request: VercelRequest | { headers: any }): JWTVerificationResult {
